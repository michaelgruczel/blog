---
layout: post
title:  "example on how to implement a MCP server with a cooking recipe search and a recipe retrieval endpoint using python and a vector DB."
date:   2025-11-28 11:14:42 +0100
categories: AI
---
Example on how to implement a MCP server with a cooking recipe search and 
...
![flow](./../../../../assets/2025-11-28-example-mcp-server-with-vector-search/mcp-recipe-sample.png)
...
![mcp inspector](./../../../../assets/2025-11-28-example-mcp-server-with-vector-search/mcp-inspector-tools.png)
...
![lmstudio config 1](./../../../../assets/2025-11-28-example-mcp-server-with-vector-search/lmstudio-recipe-server-config-1.png)

![lmstudio config 2](./../../../../assets/2025-11-28-example-mcp-server-with-vector-search/lmstudio-recipe-server-config-2.png)

Now we can give it a try

![lmstudio chat 1](./../../../../assets/2025-11-28-example-mcp-server-with-vector-search/lmstudio-recipe-server-chat-1.png)

![lmstudio chat 2](./../../../../assets/2025-11-28-example-mcp-server-with-vector-search/lmstudio-recipe-server-chat-2.png)
